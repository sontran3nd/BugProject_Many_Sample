...
public class ChatHeadService extends Service {
    ...
    public void onCreate() {
        ...
        mChatHeadView = LayoutInflater.from(this).inflate(R.layout.message_header, null);
        ...
        final TextView txtMessage = mChatHeadView.findViewById(R.id.chat_head_message);
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        if (lastAction == MotionEvent.ACTION_DOWN) {
                            ...
                            Intent intent = new Intent(ChatHeadService.this, DetailActivity.class);
